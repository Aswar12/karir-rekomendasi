                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr
                            ...
                            <td class="px-6 py-4">
                                {{ $pekerjaan->name_pekerjaan }}
                            </td>
                            <td class="px-6 py-4">
                                <div class="row flex-shrink-0">

                                    <a href={{ route('pekerjaan.edit', $pekerjaan->id) }}
                                        class="inline-flex px-2 py-2 mx-1 mb-1 font-bold text-white bg-blue-500 rounded
                                        hover:bg-blue-700">
                                    ...
                                    <form action="{{ route('pekerjaan.delete', $pekerjaan->id) }}" method="POST"
                                        class="inline-block">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                                    ...
                                    <a href="{{ route('nilaiPekerjaan.show',$pekerjaan->id ) }}"
