                        ...
                        <tr
                                ...
                                <table class="border-2">
                                    <tbody>
                                        ...
                                        <tr class="border-2 dark:bg-gray-800 dark:border-gray-700">
                                            <td class="px-6 py-4 border-y-2 border-collapse">
                                                {{ $subkriteria->nama_subkriteria }}
                                            </td>
                                            <td class="px-6 py-4 border-y-2 border-collapse">
                                                {{ $subkriteria->bobot }}
                                            </td>
                                            <td class=" border-y-2 border-collapse">
                                                <a href="{{ route('kriterias-sub.edit', $subkriteria->id ) }}"
                                                    class="inline-flex px-2 py-2 mx-1 my-1 font-bold text-white bg-blue-500 rounded hover:bg-blue-700">
                                            ...
                                            <td class=" border-y-2 border-collapse">
                                                <form action="{{ route('kriterias-sub.delete', $subkriteria->id) }}"
                                                    method="POST" class="inline-block">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
                                                        class="flex px-2 py-2 mx-2 my-1  font-bold text-white bg-red-500 rounded hover:bg-red-700">
                                                        <svg xmlns="http://www.w3.org/2000/svg" height="1em"
                                                            viewBox="0 0 448 512">
                                                            <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                                            <path
                            ...
                            <td class="px-6 py-4">
                                <div class="row flex-shrink-0">
                                    <a href={{ route('kriterias-sub.create', $kriteria->id ) }}
                                        class="inline-flex px-2 py-2 mx-1 mb-1 font-bold text-white bg-green-500 rounded
                                        hover:bg-green-700">
                                        ...
                                        </svg><span class="mx-1"> Sub Kriteria</span>
                                    </a>
                                    ...
                                    <form action="{{ route('kriterias.delete', $kriteria->id) }}" method="POST"
                                        class="inline-block">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
