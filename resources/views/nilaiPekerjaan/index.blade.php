        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
            ...
            <div class="bg-white rounded-xl mt-6 overflow-hidden  shadow-xl sm:rounded-lg">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        @foreach ($nilaiPekerjaan as $index => $nilai )
                        <tr
                            ...
                            <td class="px-6 py-4">
                                {{ $nilai->pekerjaan->name_pekerjaan }}
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                <div class="row flex-shrink-0">
                                    ...
                                    <a href="/nilaiPekerjaan-edit-{{ $nilai->id }}"
                                    ...
                                    <form action="{{ route('nilaiPekerjaan.delete', $nilai->id) }}" method="POST"
                                        class="inline-block">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                                    ...
                                    <a href="{{ route('nilaiPekerjaan.show', $nilai->pekerjaan_id ) }}"
