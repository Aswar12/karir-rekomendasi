<div class="p-6 lg:p-8 bg-white border-b border-gray-200 flex flex-col lg:flex-row">
    <x-application-logo class="block h-20 w-auto mb-4 lg:mb-0 lg:mr-8" /> <!-- Adjusted image size -->

    <div class="lg:bg-gray-200 lg:bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
        <div class="text-lg text-black leading-7 font-semibold mb-4 lg:mb-0">
        ...
        {{-- <div class="text-gray-500 mb-4 lg:mb-0">
            ...
            <a href="https://www.unikama.ac.id/">Website</a>
        </div> --}}
    </div>
</div>
