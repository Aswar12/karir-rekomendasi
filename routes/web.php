...
Route::middleware([
    ...
    // Route::delete('/nilaiMahasiswa-delete-{nilaiMahasiswa}', [NilaiMahasiswaController::class, 'destroy'])->name('nilaiMahasiswa.delete');
     Route::get('/nilaiMahasiswa', [NilaiMahasiswaController::class, 'index'])->name('nilaiMahasiswa.index');
    Route::get('/nilaiMahasiswa-create', [NilaiMahasiswaController::class, 'create'])->name('nilaiMahasiswa.create');
    Route::post('/nilaiMahasiswa-store', [NilaiMahasiswaController::class, 'store'])->name('nilaiMahasiswa.store');
    Route::get('/nilaiMahasiswa-edit-{kriteria}', [NilaiMahasiswaController::class, 'edit'])->name('nilaiMahasiswa.edit');
    Route::put('/nilaiMahasiswa-update-{kriteria}', [NilaiMahasiswaController::class, 'update'])->name('nilaiMahasiswa.update');
    Route::delete('/nilaiMahasiswa-delete-{kriteria}', [NilaiMahasiswaController::class, 'destroy'])->name('nilaiMahasiswa.delete');
